...
NON_ENERGY_MINERALS = ['GMKN', 'PLZL', 'CHMF', 'NLMK', 'RUAL', 'MAGN', 'ALRS', 'VSMO',
                       'ENPG', 'TRMK', 'POLY', 'MTLR', 'SELG', 'ROLO', 'AMEZ', 'CHMK',
...
_STOCKS_LISTS = [ENERGY_MINERALS, NON_ENERGY_MINERALS, FINANCE, UTILITIES, PROCESS_INDUSTRIES, ELECTRONIC_TECHNOLOGY, TECHNOLOGY_SERVICES, COMMUNICATIONS, TRANSPORTATION,
...
STOCKS = [item for sublist in _STOCKS_LISTS for item in sublist]

INTERESTED = ['ROSN', 'LKOH', 'GAZP', 'NVTK', 'SIBN', 'SNGS', 'TATN', 'BANE', 
                  'RNFT', 'GMKN', 'PLZL', 'CHMF', 'NLMK', 'RUAL', 'MAGN', 'ALRS',
                   'TRMK', 'POLY', 'MTLR', 'SELG', 'CHMK',
                       'LNZL','SBER', 'VTBR', 'TCSG', 'MOEX','SMLT', 'POSI',
                       'IRAO', 'HYDR', 'FEES','PHOR', 'AGRO', 'AQUA', 'SGZH',
                        'YNDX', 'VKCO', 'CIAN', 'HHRU', 'MTSS', 'RTKM', 'AFKS', 'MGTS',
                      'FLOT', 'FESH', 'NMTP', 'AFLT', 'MGNT', 'FIXP', 'LENT', 'OKEY', 'OZON',
                       'PIKK','ETLN', 'BELU', 'ABRD']
